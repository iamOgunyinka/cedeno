...
ABSL_FLAG(std::string, start_time, "2023-01-01",
...
ReadHistory(const std::string &delimited_proto_file, absl::Time start_time,
            absl::Time end_time) {
...
absl::StatusOr<std::unique_ptr<std::ofstream>>
OpenLogFile(const std::string &log_filename) {
