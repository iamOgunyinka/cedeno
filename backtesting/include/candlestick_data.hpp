...
/// This is the kline configuration sent from the user (most likely from the
/// Python script) specifying the symbol needed, start and end time, trade type
/// and an optional callback to get periodic data
